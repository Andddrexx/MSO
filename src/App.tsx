          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                ...
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Nos posicionamos como el <strong className="text-amber-400">engranaje</strong> que articula cada elemento, asegurando que todo funcione con precisión y armonía. Nos emociona conectar con las personas a través de lo que hacemos y valoramos profundamente la confianza que depositas en nosotros.
              </p>
                <p>
